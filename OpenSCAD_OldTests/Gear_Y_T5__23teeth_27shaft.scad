...
//RN: Standard hobby pully is GT2_2mm
//RN: X knob (lower/smaller) -- shaft 26.25 mm, 60 teeth
//RN: Y knob (upper/larger) -- shaft 29.5 mm, 60 teeth
//RN:
//RN: AmScope 120 series circa 2018:
//RN: X knob (lower/smaller) -- shaft 23 mm
//RN: Y knob (upper/larger) -- shaft 26 mm
//RN: Made the shafts 1 mm larger to handle variances in my printer.


// tuneable constants

teeth = 23;			// Number of teeth, standard Mendel T5 belt = 8, gives Outside Diameter of 11.88mm

motor_shaft = 27.25;	// NEMA17 motor shaft exact diameter = 5
