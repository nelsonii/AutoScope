...
//true=render the gear, false=hide the gear
bGearAExists=true;
bGearBExists=false;
...
difference(){
  ...
  union(){
    ...
    if (bGearBExists){
      ...
      translate([OurCenterDistanceNamedBob,0,0]){cylinder(h=GearHeight+2,d=GearBHub,$fn=60,center=true);}
    }//bGearBExits
  }//union
